...
use crate::constants::{
    AIR_CAPSULE_SCORE_STEP, DIAMOND_SCORE, FIELD_WIDTH_DEFAULT, LEVEL_STEP_M, LIVES_DEFAULT,
    LIVES_MAX, LIVES_MIN, OXYGEN_MAX, ROCK_BREAK_OXYGEN_PENALTY, SCORE_PER_AUTO_VANISH_BLOCK,
    SCORE_PER_DRILLED_BLOCK,
};
